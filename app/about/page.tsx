          ...
          <div className="about-content">
            <div className="text-section">
              ...
              <p className="description">
                ...
                Fueled by a passion for cuttingedge technologies I am on a mission to leverage these skills for an impactful freelancing venture
                With a commitment to continuous growth I am excited about contributing to innovative projects and connecting with like-minded professionals
